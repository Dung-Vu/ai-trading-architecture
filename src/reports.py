...
<footer>Generated by AI Trading Architecture — BacktestReport</footer>
    ...
    def _build_markdown(self) -> str:
        ...
        # Save equity chart as separate HTML and link it
        eq_path = Path(output_path).parent / "equity_curve.html" if (output_path := "") else ""
        ...
        lines.append("")
        lines.append("---")
        lines.append(f"*Generated by AI Trading Architecture — BacktestReport*")
        return "\n".join(lines)
